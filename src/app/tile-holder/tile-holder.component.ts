...
export class TileHolderComponent implements OnInit {
  ...
  constructor() {
    this.tiles.push( new TileData ('../assets/ryu.png','FIREBALL', 'A showcase of my problem solving proccess', '> See project','rgb(255, 189, 122)','black','rgb(31, 31, 31)','dev/fireball'))
